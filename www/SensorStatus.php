...
<?php
  ...
  if(isset($_POST["ip_address"]) && isset($_POST["udp_port"]) && isset($_POST["remove"]))
  {
    ...
    $headStr = "
      ...
      <title> ESP8266 1-Wire Temperature Status </title>
...
<table width="100%" border="0" cellspacing="0" cellpadding="2">
      ...
      <table width="100%" border="1" cellspacing="0" cellpadding="2">
        <tr>
          <td align="center" border="2" colspan="6">
            <?php
              $titleStr = "<h2><font color = \"blue\">ESP8266 1-Wire Temperature Status</font></h2>";
              echo $titleStr;
            ?>
          </td>
        </tr>
  ...
  <tr>
    <td  align="center" colspan="6">
      <form method="post" action="/esp8266t/SensorStatus.php">
